            ...
            function(result) {
                ...
                for (var i = 0; i < reputations.length; i++) {
                    ...
                    if (reput.imgs[0] == null || reput.imgs[0] == "") {
                        ...
                        reput.imgs[0] += "?imageView2/1/w/640/h/340/format/yjpg/q/70&max_age=19830212&d=20151230193947";
                    }
                    reldata.push(reput);
...
//        location.href = junmpurl;
    ...
    $("body").on("touchstart", function(e) {
        start=e.originalEvent.changedTouches[0].screenY;
    })
    $("body").on("touchmove", function(e) {
        move=e.originalEvent.changedTouches[0].screenY;
        y=start-move;
    });

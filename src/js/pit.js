...
//                };
    ...
    {
        var indexflag = parseInt(sessionStorage.getItem('pit_indexflag'));
        var swiper = new Swiper('.swiper-container', {
            ...
            onSlideChangeEnd: function(swiper) {
                ...
                sessionStorage.removeItem('pit_indexflag');
                sessionStorage.setItem('pit_indexflag',indexflag);
            }
        });
    };

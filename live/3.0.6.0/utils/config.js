...
var WEB_CONFIG = (function(root, factory) {
    ...
    //定义当前环境
    var _ENV_PATH = 3; //0:开发,1:测试,2:live,3:正式,默认:开发
    //定义客户端内部跳转环境
    var _JUMP_URL = 2; //0:开发,1:测试,2:live,3:正式,默认:开发
    /**
     * [HOST 获取服务器接口地址]
    ...
    factory.NATIVE_JUMP = function(){
        ...
        switch (_JUMP_URL){
            case 0:
                jump_url = "http://ued.huizhuang.com/dep/hzone_v2/3.0.6.0/";
                break;
            case 1:
                jump_url = "http://hzone.live.huizhuang.com/3.0.6.0/";
                break;
            case 2:
                jump_url = "http://hzone.live.huizhuang.com/3.0.6.0/";
                break;
 			case 3:
                jump_url = "http://hzone.huizhuang.com/3.0.6.0/";
                break;
            default:
                jump_url = "http://ued.huizhuang.com/dep/hzone_v2/3.0.6.0/";
                break;
